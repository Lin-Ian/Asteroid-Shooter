...
class Bullets(arcade.Sprite):
    ...
    def __init__(self, filename, scale):
        ...
        self.center_x = 0
        self.center_y = 0
        self.laser = arcade.load_sound(r"media/laser.mp3")
        self.explode = arcade.load_sound(r"media/explode.mp3")
...
class Asteroid(arcade.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__("media/asteroid.png", 0.1)
...
class HomeScreen:
    ...
    def __init__(self):
        ...
        self.menu = True
        self.home_screen_background = arcade.load_texture("media/galaxy.jpg")
...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.game_background = arcade.load_texture("media/space.jpg")
        self.game_over_screen = arcade.load_texture("media/game over screen.jpg")
        self.win_screen = arcade.load_texture("media/win screen.jpg")
    ...
    def setup(self):
        ...
        self.player_sprite = ShipSprite(r'media/plane.png', 0.075)
        ...
        for i in range(self.player_sprite.lives):
            life = arcade.Sprite(r"media/plane.png", 0.05)
    ...
    def on_key_press(self, key, modifiers):
        ...
        if self.play_game:
            ...
            # Shoot lasers
                ...
                self.bullet_sprite = Bullets(r'media/laser.png', 0.25)
